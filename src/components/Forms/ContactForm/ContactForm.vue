            ...
            <div class="trajet">
                ...
                <div class="row">
                    <article class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                        ...
                        <p>
                            Prendre la ligne 2 du métro et descendre à la
                            station Monceau. Prendre la sortie bd de courcelles.
                            Prendre la direction ouest du Boulevard de
                            Courcelles/Place de la république Dominicaine vers
                            Avenue Ferdousi.
                        </p>
                    </article>
                    <article class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                        ...
                        <p>
                            Superatis Tauri montis verticibus qui ad solis ortum
                            sublimius attolluntur, Cilicia spatiis porrigitur
                            late distentis dives bonis omnibus terra, eiusque
                            lateri dextro adnexa Isauria, pari sorte uberi
                            palmite viget et frugibus minutis, quam mediam
                            navigabile flumen Calycadnus interscindit.
                        </p>
                    </article>
                    <article class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                        <h4><i class="fas fa-car mr-3"></i>En véhicule</h4>
                        <p>
                            Rentrer l'adresse : Parc Monceau, 35 Boulevard de
                            Courcelles, 75008 Paris dans votre gps et suivez les
                            instructions.
                        </p>
                    </article>
                </div>
