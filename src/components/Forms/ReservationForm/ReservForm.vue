     ...
     <form @submit.prevent="submit" class="">
      ...
      <div class="form-row">
       <div class="form-group col-md-6">
        ...
        <div class="invalid-feedback">
         <span v-if="!$v.Address.required">L'adresse est requis !</span>
         <span v-if="!$v.Address.minLength"
          >L'adresse doit avoir au moins
          {{ $v.Address.$params.minLength.min }} lettres !</span
         >
         <span v-if="!$v.Address.maxLength"
          >L'adresse doit au plus avoir
          {{ $v.Address.$params.maxLength.max }} lettres !</span
         >
        </div>
       </div>
       <div class="form-group col-md-6 complement">
        <label for="inputAddressC">Complément adresse</label>
        <input
         v-model="AddressC"
         type="text"
         class="form-control"
      ...
      <div class="form-row">
       <div class="form-group col-md-6">
        ...
        />
        <div class="valid-feedback">La ville est valide !</div>
        <div class="invalid-feedback">
         <span v-if="!$v.City.required">La ville est requis !</span>
         <span v-if="!$v.City.minLength"
          >L'adresse doit avoir au moins
          {{ $v.City.$params.minLength.min }} lettres !</span
         >
         <span v-if="!$v.City.maxLength"
          >La ville doit au plus avoir
          {{ $v.City.$params.maxLength.max }} lettres !</span
         >
        </div>
       </div>
       <div class="form-group col-md-6">
        ...
        />
        <div class="valid-feedback">Le code postal est valide !</div>
        <div class="invalid-feedback">
         <span v-if="!$v.Zip.required">Le code postal est requis !</span>
         <span v-if="!$v.Zip.minLength"
          >Le code postal doit avoir au moins
          {{ $v.Zip.$params.minLength.min }} lettres !</span
         >
         <span v-if="!$v.Zip.numeric">Le code postal n'est pas valide !</span>
         <span v-if="!$v.Zip.maxLength"
          >Le code postal doit au plus avoir
          {{ $v.Zip.$params.maxLength.max }} lettres !</span
         >
        </div>
       </div>
      </div>
      <div class="form-row">
       <div class="form-group col-md-4">
        <label for="selectFilms">Film <span class="required">*</span></label>
        <select
         ...
         class="form-control"
        >
         <option v-for="(film, index) in Films" v-bind:key="index">{{
          film.Titre
         }}</option>
        </select>
        <div class="invalid-feedback">
         <span v-if="!$v.Film.required">Le film est requis !</span>
        </div>
       </div>
       <div class="form-group col-md-4">
        <label for="selectSeance">Séance <span class="required">*</span></label>
        <select
         ...
         class="form-control"
        >
         <option v-for="(seance, index) in Seances" v-bind:key="index">{{
          seance
         }}</option>
        </select>
        <div class="invalid-feedback">
         <span v-if="!$v.Film.required">La séance est requis !</span>
        </div>
       </div>
       <div class="form-group col-md-4">
        <label for="selectDate">Date <span class="required">*</span></label>
        <input
        ...
        />
        <div class="invalid-feedback">
         <span v-if="!$v.Film.required">La date est requis !</span>
        </div>
       </div>
      </div>
      <div class="form-group">
